...
t_AAAAA1111 = Table(
    'AAAAA1111', Base.metadata,
    Column('StaffSalaryDetailsId', INTEGER(11)),
    Column('StaffId', String(50, 'utf8mb4_unicode_ci')),
    Column('FullName', String(50, 'utf8mb4_unicode_ci')),
    Column('CompanyId', String(50, 'utf8mb4_unicode_ci')),
    Column('WorkProfilePositionId', String(100, 'utf8mb4_unicode_ci')),
    Column('ContractType', String(50, 'utf8mb4_unicode_ci')),
    Column('BranchId', String(50, 'utf8mb4_unicode_ci')),
    Column('StartDate', Double(10, True)),
    Column('Shift', String(50, 'utf8mb4_unicode_ci')),
    Column('Total', INTEGER(11)),
    Column('NoTimekeeping', String(50, 'utf8mb4_unicode_ci')),
    Column('Actual Hours Worked', String(50, 'utf8mb4_unicode_ci')),
    Column('AnnualLeave', String(50, 'utf8mb4_unicode_ci')),
    Column('PaidLeave', String(50, 'utf8mb4_unicode_ci')),
    Column('PublicHolidaysLeave', String(50, 'utf8mb4_unicode_ci')),
    Column('TotalStandardHours', Double(10, True)),
    Column('StandardWage', INTEGER(11)),
    Column('BasicSalary', INTEGER(11)),
    Column('PerformanceBonus', INTEGER(11)),
    Column('LunchAllowance', INTEGER(11)),
    Column('UniformAllowance', INTEGER(11)),
    Column('TotalIncomeWorkingDays', INTEGER(11)),
    Column('CRM/CSBonus', String(50, 'utf8mb4_unicode_ci')),
    Column('ServiceQualityBonus', String(50, 'utf8mb4_unicode_ci')),
    Column('GeneralManagermentBonus', String(50, 'utf8mb4_unicode_ci')),
    Column('EfficiencyManagementBonus', String(50, 'utf8mb4_unicode_ci')),
    Column('EbitdaBonus', String(50, 'utf8mb4_unicode_ci')),
    Column('VinmecBonus', String(50, 'utf8mb4_unicode_ci')),
    Column('SecurityBonus', String(50, 'utf8mb4_unicode_ci')),
    Column('HolidayBonus', String(50, 'utf8mb4_unicode_ci')),
    Column('TotalBonus', INTEGER(11)),
    Column('ParkingTravelAllowance', String(50, 'utf8mb4_unicode_ci')),
    Column('ProfessionalCertificateAllowance', INTEGER(11)),
    Column('OtherAllowances', String(50, 'utf8mb4_unicode_ci')),
    Column('TotalAllowances', INTEGER(11)),
    Column('OtherDeductions', String(50, 'utf8mb4_unicode_ci')),
    Column('TotalIncomeBeforeTax', INTEGER(11)),
    Column('ParticipatingSalaryInSocialInsurance', INTEGER(11)),
    Column('PersonalHealthInsurance', INTEGER(11)),
    Column('PersonalSocialInsurance', INTEGER(11)),
    Column('PersonalUnemploymentInsurance', INTEGER(11)),
    Column('EmployeeSocialInsurance', INTEGER(11)),
    Column('EmployeeUnionFee', INTEGER(11)),
    Column('CompanySocialInsurance', INTEGER(11)),
    Column('CompanyOccupaitionalAccidentOrDisease', INTEGER(11)),
    Column('CompanyHealthInsurance', INTEGER(11)),
    Column('CompanyUnemploymentInsurance', INTEGER(11)),
    Column('EnterpriseSocialInsurance', INTEGER(11)),
    Column('EnterpriseUnionFee', INTEGER(11)),
    Column('LunchOrUniformAllowanceNoTax', INTEGER(11)),
    Column('TotalTaxableIncome', INTEGER(11)),
    Column('TaxableIncomeObject', String(50, 'utf8mb4_unicode_ci')),
    Column('Commitment', String(50, 'utf8mb4_unicode_ci')),
    Column('Dependents', INTEGER(11)),
    Column('TotalAssessableIncome', INTEGER(11)),
    Column('PersonalIncomeTaxCollection', INTEGER(11)),
    Column('ActualPayment', INTEGER(11)),
    Column('CompanyPaysSocialInsurance', INTEGER(11)),
    Column('WithholdSocialInsurance', INTEGER(11)),
    Column('BankTransfer', INTEGER(11)),
    Column('Name', String(50, 'utf8mb4_unicode_ci')),
    Column('AccountNumber', Double(15, True)),
    Column('Bank', String(50, 'utf8mb4_unicode_ci')),
    Column('Email', String(50, 'utf8mb4_unicode_ci')),
    Column('TransferAmount', INTEGER(11)),
    Column('Additional', INTEGER(11)),
    Column('Notes', String(50, 'utf8mb4_unicode_ci')),
    Column('PaymentDate', String(50, 'utf8mb4_unicode_ci')),
    Column('Level', String(50, 'utf8mb4_unicode_ci')),
    Column('SalaryPerHour', String(50, 'utf8mb4_unicode_ci')),
    Column('CompensatoryLeave', String(50, 'utf8mb4_unicode_ci')),
    Column('TotalLunchAllowance', String(50, 'utf8mb4_unicode_ci')),
    Column('FixedIncomeWithLunchAllowance', String(50, 'utf8mb4_unicode_ci')),
    Column('FixedIncomeAmountWithLunchAllowance', String(50, 'utf8mb4_unicode_ci')),
    Column('TaskBonus', String(50, 'utf8mb4_unicode_ci')),
    Column('ClinicsAchievingKPIRevenueBonus', String(50, 'utf8mb4_unicode_ci')),
    Column('AssistantManagerAndConcurrentBonus', String(50, 'utf8mb4_unicode_ci')),
    Column('GuaranteedIncomeAllowance', String(50, 'utf8mb4_unicode_ci')),
    Column('DentalTour', String(50, 'utf8mb4_unicode_ci')),
    Column('WarehouseAllowance', String(50, 'utf8mb4_unicode_ci')),
    Column('OtherTotalIncome', String(50, 'utf8mb4_unicode_ci')),
    Column('CertificateAllowance', String(50, 'utf8mb4_unicode_ci')),
    Column('DoctorBonus', String(50, 'utf8mb4_unicode_ci')),
    Column('AdjustmentForDecemberShortfall', String(50, 'utf8mb4_unicode_ci')),
    Column('PayPeriod', String(50, 'utf8mb4_unicode_ci')),
    Column('Template', String(50, 'utf8mb4_unicode_ci'))
)
...
t_ABO2 = Table(
    ...
    Column('Lương cơ bản', String(50, 'utf8mb4_unicode_ci')),
    Column('Thưởng Ý thức và Tuân thủ/Thưởng Hiệụ quả hoạt động', String(50, 'utf8mb4_unicode_ci')),
    Column('Tổng cộng', String(50, 'utf8mb4_unicode_ci')),
    ...
    Column('Công chuẩn', String(50, 'utf8mb4_unicode_ci')),
    Column('Lương cơ bản1', String(50, 'utf8mb4_unicode_ci')),
    Column('Thưởng Ý thức và Tuân thủ/Thưởng Hiệụ quả hoạt động1', String(50, 'utf8mb4_unicode_ci')),
    Column('Tổng thu nhập theo ngày công', String(50, 'utf8mb4_unicode_ci')),
    ...
    Column('Tổng thu nhập trước thuế', String(50, 'utf8mb4_unicode_ci')),
    ...
    Column('Doanh nghiệp đóng Công đoàn 2%', INTEGER(11)),
    Column('Không tính thuế (Phụ cấp cơm trưa/ Đồng phục)', String(50, 'utf8mb4_unicode_ci')),
    Column('TỔNG THU NHẬP CHỊU THUẾ', String(50, 'utf8mb4_unicode_ci')),
    ...
    Column('Thực lãnh', String(50, 'utf8mb4_unicode_ci')),
    Column('Cty đóng hộ BHXH', String(50, 'utf8mb4_unicode_ci')),
    Column('Thu hộ tiền BHXH (21.5%', INTEGER(11)),
    Column('Chuyển khoản', Double(10, True)),
    Column('Column1', String(50, 'utf8mb4_unicode_ci')),
    Column('Họ & tên', String(50, 'utf8mb4_unicode_ci')),
    Column('Số tài khoản', String(50, 'utf8mb4_unicode_ci')),
    Column('Ngân hàng', String(50, 'utf8mb4_unicode_ci')),
    Column('Mail', String(50, 'utf8mb4_unicode_ci')),
    Column('Đã Chuyển khoản 05/02/2024', Double(10, True)),
    Column('Bổ sung', INTEGER(11)),
    Column('Ghi chú', String(50, 'utf8mb4_unicode_ci')),
    Column('Ngày thanh toán', String(50, 'utf8mb4_unicode_ci'))
)
...
t_ASalaryBO = Table(
    'ASalaryBO', Base.metadata,
    Column('StaffSalaryDetailsId', INTEGER(11)),
    Column('StaffId', INTEGER(11)),
    Column('StaffCode', String(50, 'utf8mb4_unicode_ci')),
    Column('FullName', String(50, 'utf8mb4_unicode_ci')),
    Column('Company', String(50, 'utf8mb4_unicode_ci')),
    Column('WorkProfilePosition', String(100, 'utf8mb4_unicode_ci')),
    Column('ContractType', String(50, 'utf8mb4_unicode_ci')),
    Column('Branch', String(50, 'utf8mb4_unicode_ci')),
    Column('StartDate', Double(10, True)),
    Column('Shift', String(50, 'utf8mb4_unicode_ci')),
    Column('Total', INTEGER(11)),
    Column('NoTimekeeping', String(50, 'utf8mb4_unicode_ci')),
    Column('ActualHoursWorked', String(50, 'utf8mb4_unicode_ci')),
    Column('AnnualLeave', String(50, 'utf8mb4_unicode_ci')),
    Column('PaidLeave', String(50, 'utf8mb4_unicode_ci')),
    Column('PublicHolidaysLeave', String(50, 'utf8mb4_unicode_ci')),
    Column('TotalStandardHours', Double(10, True)),
    ...
    Column('Dependents', INTEGER(11)),
    Column('TotalAssessableIncome', INTEGER(11)),
    Column('PersonalIncomeTaxCollection', String(50, 'utf8mb4_unicode_ci')),
    Column('ActualPayment', INTEGER(11)),
    Column('CompanyPaysSocialInsurance', INTEGER(11)),
    Column('WithholdSocialInsurance', INTEGER(11)),
    Column('BankTransfer', INTEGER(11)),
    Column('Name', String(50, 'utf8mb4_unicode_ci')),
    Column('AccountNumber', String(255, 'utf8mb4_unicode_ci')),
    Column('Bank', String(50, 'utf8mb4_unicode_ci')),
    Column('Email', String(50, 'utf8mb4_unicode_ci')),
    Column('TransferAmount', INTEGER(11)),
    Column('Additional', INTEGER(11)),
    ...
    Column('AdjustmentForDecemberShortfall', String(50, 'utf8mb4_unicode_ci')),
    Column('PayPeriod', String(50, 'utf8mb4_unicode_ci')),
    Column('Template', INTEGER(11), server_default=text("'1'"), comment='1-BO\n2-Phu ta\n3-Bac Si\n4-Bao ve')
)
